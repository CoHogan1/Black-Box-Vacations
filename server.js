...
const whitelist = ['http://localhost:3000',backEnd,"https://bbvacationsbackend.herokuapp.com",'http://localhost:3003',process.env.BASEURL,heroku,"https://blackbfrontend.herokuapp.com"]
const corsOptions = {
